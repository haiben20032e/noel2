...
let text = "Em yêu, trong không khí se lạnh của mùa Giáng sinh, trái tim anh lại ấm áp hơn bao giờ hết vì có em. Chúc người anh yêu một Giáng sinh ngọt ngào và hạnh phúc. Anh yêu em!"
...
let imgPath = "/c11.jpg"; // Thay đường dẫn này bằng ảnh trong dự án của bạn
let imgContainer = document.createElement("img");
imgContainer.src = imgPath;
imgContainer.alt = "Giáng sinh ngọt ngào";
imgContainer.style.maxWidth = "100%";
imgContainer.style.marginTop = "20px";

// Gắn ảnh vào DOM
document.querySelector(".cart-page-bottom").appendChild(imgContainer);
...
// Lấy đối tượng âm thanh từ ID
var audio = document.getElementById("c13");

// Phát âm thanh tự động khi trang web tải xong
audio.play();
